...
<a href="#" id="removeCart_{$rsProduct['id']}" {if ! $itemInCart}class="hidene" /if} onclick="removeFromCart({$rsProduct['id']}); return false;" alt='Удалить из корзины'>Удалить из корзины</a>
